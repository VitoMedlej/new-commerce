  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log('data?.products: ', data?.data?.products);
...
{resImages?.fifth && <Box
  ...
  <Typography sx={{ fontWeight: '500', fontSize: '.65em', textAlign: 'center', px: 1 }}>
    Materials
      ...
      <Box/>
        <HomeProductsCarousel Collectiontitle={"Shop Our Latest Products"} delay={3000} data={data}/>
        {/* <Container>
        <Typography
